...
/*
EXECUTE  [dbo].[Usp_County_RealEstate_History_USA_INSERT] 
*/

Create proc [dbo].[Usp_County_RealEstate_History_USA_INSERT]
as
BEGIN
BEGIN TRY  
		BEGIN TRANSACTION;

		MERGE INTO [dbo].[County_RealEstate_History_USA] Target
		USING [stage].[County_RealEstate_History_USA] Source
