...
/*
EXECUTE  [dbo].[Usp_Metro_RealEstate_History_USA_INSERT] 
*/

create proc [dbo].[Usp_Metro_RealEstate_History_USA_INSERT]
as
BEGIN
BEGIN TRY  
		BEGIN TRANSACTION;

		MERGE INTO [dbo].[Metro_RealEstate_History_USA] Target
		USING [stage].[Metro_RealEstate_History_USA] Source
		ON Target.[month_date_yyyymm]=Source.[month_date_yyyymm]
		and Target.cbsa_title=Source.cbsa_title
