...
/*
EXECUTE  [dbo].[Usp_State_RealEstate_History_USA_INSERT] 
*/

CREATE proc dbo.Usp_State_RealEstate_History_USA_INSERT
as
BEGIN
BEGIN TRY  
		BEGIN TRANSACTION;

		MERGE INTO [dbo].[State_RealEstate_History_USA] Target
		USING [stage].[State_RealEstate_History_USA] Source
