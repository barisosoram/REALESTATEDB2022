...
/*
EXECUTE  [dbo].[Usp_ZipCode_RealEstate_History_USA_INSERT] 
*/

create proc [dbo].[Usp_ZipCode_RealEstate_History_USA_INSERT]
as
BEGIN
BEGIN TRY  
		BEGIN TRANSACTION;

		MERGE INTO [dbo].[ZipCode_RealEstate_History_USA] Target
		USING [stage].[ZipCode_RealEstate_History_USA] Source
